            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 max-w-2xl mx-auto lg:mx-0">
                <p className="text-xl lg:text-2xl text-muted-foreground font-light leading-relaxed">
                  +10 years building <span className="text-foreground font-medium">cloud platforms</span> and <span className="text-foreground font-medium">scalable infrastructure</span> at companies like BlackRock, Anaplan, and Entelo.
                </p>
